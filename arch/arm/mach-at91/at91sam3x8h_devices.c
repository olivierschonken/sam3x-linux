 ...
 * -------------------------------------------------------------------- */
/* Change this to an usb-otg driver ... */
#if defined(CONFIG_USB_ATMEL_USBA) || defined(CONFIG_USB_ATMEL_USBA_MODULE)
static struct resource usba_udc_resources[] = {
	[0] = {
		.start	= AT91SAM3X_BASE_UOTGHS,
		.end	= AT91SAM3X_BASE_UOTGHS + SZ_1K - 1,
		.flags	= IORESOURCE_MEM,
	},
	[1] = {
		.start	= AT91SAM3X_INT_UOTGHS,
		.end	= AT91SAM3X_INT_UOTGHS,
		.flags	= IORESOURCE_IRQ,
	},
};
 ...
 */
/*TODO : Write Atmel usb_otg driver*/
#else
...
static struct resource rtc_resources[] = {
	[0] = {
		.start	= AT91SAM3X_BASE_RTC,
		.end	= AT91SAM3X_BASE_RTC + SZ_256 - 1,
		.flags	= IORESOURCE_MEM,
	},
	[1] = {
		.start	= AT91SAM3X_RTC_ID,
		.end	= AT91SAM3X_RTC_ID,
		.flags	= IORESOURCE_IRQ,
	},
};
...
/*TODO: Write proper PWM driver for SAM3X*/
#else
...
void __init at91_add_device_ssc(unsigned id, unsigned pins)
{
	...
	at91_set_B_periph(AT91_PIN_PB22, 0);
	/*
